...
public class AgentStatusResponse {
  ...
  private final Map<Long, WorkerState> workers;

  public AgentStatusResponse(
      @JsonProperty("serverStartMs") long serverStartMs,
      @JsonProperty("workers") Map<Long, WorkerState> workers) {
  ...
  @JsonProperty
  public Map<Long, WorkerState> workers() {
    return workers;
  }
}
