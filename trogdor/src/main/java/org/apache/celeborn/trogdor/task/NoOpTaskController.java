...
import org.apache.celeborn.trogdor.platform.Topology;

/** A no-op task controller that targets a configured set of nodes. */
public class NoOpTaskController implements TaskController {
  private final Set<String> targetNodes;

  public NoOpTaskController(Set<String> targetNodes) {
