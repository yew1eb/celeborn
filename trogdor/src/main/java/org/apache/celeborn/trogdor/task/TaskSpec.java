...
/**
 * The specification for a Trogdor task. This should be immutable and suitable for serializing and
 * sending over the wire.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.CLASS, property = "class")
public abstract class TaskSpec {
  /**
   * The maximum task duration. We cap the task duration at this value to avoid worrying about
   * 64-bit overflow or floating point rounding.
   */
  ...
  protected TaskSpec(
      @JsonProperty("startMs") long startMs, @JsonProperty("durationMs") long durationMs) {
